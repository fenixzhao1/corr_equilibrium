...
for (s in 1:sim){
  ...
  for (i in (experiment+1):n){
    ...
    history_p1[i] = decision_logit_hm2001(beta, i, history_p1, history_p2, prob1_p1, prob2_p1 )[1]
    history_p2[i] = decision_logit_hm2001(beta, i, history_p2, history_p1, prob1_p2, prob2_p2 )[1]
    prob1_p1[i] = decision_logit_hm2001(beta, i, history_p1, history_p2, prob1_p1, prob2_p1 )[2]
    prob2_p1[i] = decision_logit_hm2001(beta, i, history_p1, history_p2, prob1_p1, prob2_p1 )[3]
    prob1_p2[i] = decision_logit_hm2001(beta, i, history_p2, history_p1, prob1_p2, prob2_p2 )[2]
    prob2_p2[i] = decision_logit_hm2001(beta, i, history_p2, history_p1, prob1_p2, prob2_p2 )[3]
